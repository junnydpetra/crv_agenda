...
<div class="container">
    <div class="header">
        ...
        <a href="javascript:void(0);" class="btn-add" onclick="openModal()">Adicionar Contato</a>
    </div>
            ...
            <?php if (!empty($contatos)): ?>
                <?php foreach ($contatos as $contato): ?>
                    <tr>
                        ...
                        <td>
                            <a id="btn_pencil" href="update.php?id=<?php echo $contato['con_id']; ?>" title="Editar Contato"><i class="fa-solid fa-pencil"></i></a> | 
                            <a id="btn_trash" href="javascript:void(0);" onclick="confirmDeletion(<?php echo $contato['con_id']; ?>)" title="Excluir Contato"><i class="fa-solid fa-trash"></i></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
